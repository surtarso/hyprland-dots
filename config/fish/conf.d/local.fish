...
alias ll='lsd -la'
alias la='lsd -a'
alias lazyupdate='sudo pacman -Sy archlinux-keyring && yay -Syu && yay -Yc && sudo paccache -r'
alias lsblkk='lsblk | bat -l conf -p'
alias freee='free -mth | bat -l conf -p'
alias lsusbb='lsusb | bat -l conf -p'
alias blkidd='sudo blkid | bat -l conf -p'
